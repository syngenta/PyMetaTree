...
pymetatree requires python 3.9 or higher, as well as some common and reliable third party packages
...
packages. To install pymetatree in development setting simply type:
